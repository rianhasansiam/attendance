...
flowchart TD
  ...
  Ceremony -->|confirmed operation, safe tags only| Hooks
...
| Confirmed check-in/out or saved late reason     | Attendance history/entity scopes                                           | Attendance, Dashboard, Reports, Audit                                    | None                  |
